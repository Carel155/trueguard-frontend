    ...
    <div className="w-full flex justify-center">
      <div className="max-w-screen-xl">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Collecting and Using Your Personal Data</h2>
        ...
        <ul>
          ...
          <li>
            ...
            pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and
            verifying system and server integrity).
          </li>
        </ul>
        <p>
          Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device
          when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn more about cookies on{" "}
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Children&apos;s Privacy</h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Changes to this Privacy Policy</h2>
