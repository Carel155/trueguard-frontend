  ...
  return (
    <div className="w-full flex justify-center">
      <div className="max-w-screen-xl">
        <h2 className="text-3xl mb-2 text-blue-700">Terms and Conditions</h2>
        <p>Last updated: August 06, 2024</p>
        <p>Please read these terms and conditions carefully before using Our Service.</p>
        <h2 className="text-3xl mb-2 text-blue-700">Interpretation and Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Trueguard, accessible from{" "}
              <a href="https://trueguard.io" rel="external nofollow noopener" target="_blank">
                https://trueguard.io
              </a>
            </p>
          </li>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Acknowledgment</h2>
        <p>
          These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and the Company. These
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Links to Other Websites</h2>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Termination</h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Limitation of Liability</h2>
        <p>
        ...
        <p>
          ...
          to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in connection with any provision of
          this Terms), even if the Company or any supplier has been advised of the possibility of such damages and even if the remedy fails of its
          essential purpose.
        </p>
        <p>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</h2>
        <p>
        ...
        <p>
          ...
          content provided through the Service; or (iv) that the Service, its servers, the content, or e-mails sent from or on behalf of the Company
        ...
        <p>
          ...
          some or all of the above exclusions and limitations may not apply to You. But in such a case the exclusions and limitations set forth in
          this section shall be applied to the greatest extent enforceable under applicable law.
        </p>
        <h2 className="text-3xl mb-2 text-blue-700">Governing Law</h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Disputes Resolution</h2>
        <p>
          If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.
        </p>
        <h2 className="text-3xl mb-2 text-blue-700">For European Union (EU) Users</h2>
        <p>
          If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which You are resident.
        </p>
        <h2 className="text-3xl mb-2 text-blue-700">United States Legal Compliance</h2>
        <p>
          ...
          been designated by the United States government as a &quot;terrorist supporting&quot; country, and (ii) You are not listed on any United
          States government list of prohibited or restricted parties.
        </p>
        <h2 className="text-3xl mb-2 text-blue-700">Severability and Waiver</h2>
        <h3>Severability</h3>
        <p>
        ...
        <h3>Waiver</h3>
        <p>
          Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Translation Interpretation</h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Changes to These Terms and Conditions</h2>
        <p>
        ...
        <h2 className="text-3xl mb-2 text-blue-700">Contact Us</h2>
        <p>If you have any questions about these Terms and Conditions, You can contact us:</p>
        <ul>
          <li>By email: info@trueguard.io</li>
        </ul>
      </div>
    </div>
  );
